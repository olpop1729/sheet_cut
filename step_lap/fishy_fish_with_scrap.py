...
Fishy fish with scrap cutting module. 
Extends the basic fishy fish module with scrap length handling.
Uses the shared modules for configuration and pandas utilities.
"""
