...
# Define Our Columns
my_tree['columns'] = ("Cut Type", "L", "Temp")

# Formate Our Columns
my_tree.column("#0", width=0, stretch=NO)
my_tree.column("Cut Type", anchor=W, width=140)
my_tree.column("L", anchor=CENTER, width=100)
my_tree.column("Temp", anchor=W, width=140)

# Create Headings
my_tree.heading("#0", text="", anchor=W)
my_tree.heading("Cut Type", text="Cut Type", anchor=W)
my_tree.heading("L", text="L", anchor=CENTER)
...
#Labels
nl = Label(add_frame, text="Cut Type")
nl.grid(row=0, column=0)

il = Label(add_frame, text="L")
il.grid(row=0, column=1)

tl = Label(add_frame, text="Temp")
...
add_record.pack(side=LEFT,pady=5)

# Remove all
remove_all = Button(root, text="Clear All", command=remove_all)
remove_all.pack(side=LEFT,pady=5)
...
# Remove Many Selected
remove_many = Button(root, text="Delete Selected", command=remove_many)
